...
def gen_sequence(n, cube_length, radius, arities, is_relation, all_permutations, inv_threshold, 
...
if __name__ == "__main__":
	...
	print(f"Number of permutations {len(all_permutations)}")
	gen_sequence(order, cube_length, radius, arities[algebra], is_relation[algebra], all_permutations, inv_threshhold, prev_file, cube_file, out_cube_file)
